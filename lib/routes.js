    ...
    router.post('/qsos', (req, res, next) => {
        ...
        if (req.is('multipart/form-data')) {
            ...
            reader.on('data', qso => {
                ...
                if (qso.MY_STATE) {
                    qso.NOTES += ` My QTH is ${qso.MY_STATE}.`;
                }

                if (qso.MY_GRIDSQUARE) {
                    qso.NOTES += ` My gridsquare is ${qso.MY_GRIDSQUARE}.`;
                }

                if (qso.POTA_REF) {
                    qso.NOTES += ` They were at POTA Ref ${qso.POTA_REF}.`;
                }

                if (qso.MY_POTA_REF) {
                    qso.NOTES += ` I was at POTA Ref ${qso.MY_POTA_REF}.`;
                }
                ...
                if (qso.MY_RIG) {
                    qso.NOTES += ` I was using the following transceiver: ${qso.MY_RIG}.`;
                }

                if (qso.MY_ANTENNA) {
                    qso.NOTES += ` I was using the following antenna: ${qso.MY_ANTENNA}.`;
                }
