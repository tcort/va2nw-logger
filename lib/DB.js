...
class DB {
    ...
    stats(callback) {
        ...
        async.map([
            ...
            const [ bands, modes, total_qso, years, months, daysofweek, frequent_flyers, bookends, pota_activations, qro_totals, low_pwr_totals, qrp_totals, qrpp_totals, my_rigs, my_antennas, contest_totals, skcc, pota, confirms, cqz, ituz, grids ] = results;
