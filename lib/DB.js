...
class DB {
    ...
    stats(callback) {
        ...
        async.map([
            ...
            const [ bands, modes, total_qso, years, months, daysofweek, frequent_flyers, bookends, pota_activations, qrp_totals, qrpp_totals, my_rigs, my_antennas, contest_totals, skcc ] = results;
