...
class DB {
    ...
    qsoInsert(qso, callback) {
        ...
        const sql = 'INSERT INTO qsos (timeon, timeoff, frequency, mode, power, callsign, rst_sent, rst_rcvd, remarks, station_callsign, operator, spc, name, skcc, fists, contacted_op, pfx, my_spc, dxcc, my_dxcc, country, my_country, gridsquare, my_gridsquare, cq_zone, my_cq_zone, itu_zone, my_itu_zone, qsl_sent, qsl_sent_date, qsl_rcvd, qsl_rcvd_date, sota, my_sota, pota, my_pota) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?);';
        const vals = [ qso.timeon, qso.timeoff, qso.frequency, qso.mode, qso.power, qso.callsign, qso.rst_sent, qso.rst_rcvd, qso.remarks, qso.station_callsign, qso.operator, qso.spc, qso.name, qso.skcc, qso.fists, qso.contacted_op, qso.pfx, qso.my_spc, qso.dxcc, qso.my_dxcc, qso.country, qso.my_country, qso.gridsquare, qso.my_gridsquare, qso.cq_zone, qso.my_cq_zone, qso.itu_zone, qso.my_itu_zone, qso.qsl_sent, qso.qsl_sent_date, qso.qsl_rcvd, qso.qsl_rcvd_date, qso.sota, qso.my_sota, qso.pota, qso.my_pota ];
    ...
    qsoUpdate(qso_id, qso, callback) {
        ...
        const sql = 'UPDATE qsos SET timeon = ?, timeoff = ?, frequency = ?, mode = ?, power = ?, callsign = ?, rst_sent = ?, rst_rcvd = ?, remarks = ?, station_callsign = ?, operator = ?, spc = ?, name = ?, skcc = ?, fists = ?, contacted_op = ?, pfx = ?, my_spc = ?, dxcc = ?, my_dxcc = ?, country = ?, my_country = ?, gridsquare = ?, my_gridsquare = ?, cq_zone = ?, my_cq_zone = ?, itu_zone = ?, my_itu_zone = ?, qsl_sent = ?, qsl_sent_date = ?, qsl_rcvd = ?, qsl_rcvd_date = ?, sota = ?, my_sota = ?, pota = ?, my_pota = ? WHERE qso_id = ?';
        const vals = [ qso.timeon, qso.timeoff, qso.frequency, qso.mode, qso.power, qso.callsign, qso.rst_sent, qso.rst_rcvd, qso.remarks, qso.station_callsign, qso.operator, qso.spc, qso.name, qso.skcc, qso.fists, qso.contacted_op, qso.pfx, qso.my_spc, qso.dxcc, qso.my_dxcc, qso.country, qso.my_country, qso.gridsquare, qso.my_gridsquare, qso.cq_zone, qso.my_cq_zone, qso.itu_zone, qso.my_itu_zone, qso.qsl_sent, qso.qsl_sent_date, qso.qsl_rcvd, qso.qsl_rcvd_date, qso.sota, qso.my_sota, qso.pota, qso.my_pota, qso_id ];
