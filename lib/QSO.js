...
class QSO {
    ...
    toRender() {
        return {
            qso_id: this.#qso_id,
            timeon: moment(this.#timeon).utc().format('YYYY-MM-DD HH:mm:ss'),
            timeoff: moment(this.#timeoff).utc().format('YYYY-MM-DD HH:mm:ss'),
    ...
    toEdit() {
        return {
            qso_id: this.#qso_id,
            year_on: moment(this.#timeon).utc().format('YYYY'),
            month_on: moment(this.#timeon).utc().format('MM'),
            day_on: moment(this.#timeon).utc().format('DD'),
            hour_on: moment(this.#timeon).utc().format('HH'),
            minute_on: moment(this.#timeon).utc().format('mm'),
            second_on: moment(this.#timeon).utc().format('ss'),
            year_off: moment(this.#timeoff).utc().format('YYYY'),
            month_off: moment(this.#timeoff).utc().format('MM'),
            day_off: moment(this.#timeoff).utc().format('DD'),
            hour_off: moment(this.#timeoff).utc().format('HH'),
            minute_off: moment(this.#timeoff).utc().format('mm'),
            second_off: moment(this.#timeoff).utc().format('ss'),
            frequency: this.#frequency.toFixed(3),
            mode: this.#mode,
            power: this.#power,
            callsign: this.#callsign,
            ...
            was_qsl_sent: this.#qsl_sent,
            was_qsl_rcvd: this.#qsl_rcvd,
            remarks: this.#remarks,
        };
    }
