...
class QSO {
    ...
    toAO(auxData = {}) {
        return Object.assign({}, auxData, {
            ...
            SIG: (this.#pota ? 'POTA' : (this.#sota ? 'SOTA' : '')),
            SIG_INFO: (this.#pota ? this.#pota : (this.#sota ? this.#sota : '')),
            MY_SIG: (this.#my_pota ? 'POTA' : (this.#my_sota ? 'SOTA' : '')),
            MY_SIG_INFO: (this.#my_pota ? this.#my_pota : (this.#my_sota ? this.#my_sota : '')),
        });
    }
